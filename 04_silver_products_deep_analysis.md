...
### 4 Mağazada Birden Bulunan 2.064 Ürün İçin En Ucuz Mağaza Dağılımı:

Üye/Kart indirimleri dahil edilerek hesaplanan **Efektif En Düşük Fiyat (Effective Minimum Price)** bazında rekabet analizi:

| Mağaza | En Ucuz Olduğu Ürün Sayısı | En Ucuz Olduğu Yüzde (%) | Ortalama Mağaza Katalog Fiyatı (TL) | Efektif Ortalama Satış Fiyatı (TL) |
| :--- | :---: | :---: | :---: | :---: |
| **Eve Shop** | **904** | **%43,80** | 497,07 TL | **224,23 TL** |
| **Gratis** | **786** | **%38,08** | 1.063,95 TL | **409,74 TL** |
| **Watsons** | **200** | **%9,69** | 447,64 TL | **447,57 TL** |
| **Rossmann** | **174** | **%8,43** | 548,16 TL | **379,65 TL** |

---

## 6. Fiyat Dağılımı, İndirim Stratejileri ve Segmentasyon

Mağazaların fiyat bantlarına göre SKU dağılımları incelediğinde ürün konumlandırmaları açıkça görülmektedir:
...
Stok durumu ve bulunabilirlik oranları perakendeciler arasında ciddi farklılık göstermektedir:
...
2. **Kanonik Veri Modeli:** `silver_products` tablosu 4 heterojen kaynak verisini tek bir standart tablo yapısında toplamayı başarmıştır.
